...
<style>
    ...
    <div class="container my-5">
        <div class="heading text-center">
            <h1><a class="nav-link"  href="inicio1.php" style="color: black;">MUEBLES DE BAÑO</h1>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card h-">
                    <img src="fotos/baño1.png" class="card-img-top card-img-top-custom" alt="Imagen del producto 1">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card h-">
                    <img src="fotos/baño2.png" class="card-img-top card-img-top-custom" alt="Imagen del producto 2">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card h-">
                    <img src="fotos/baño3.png" class="card-img-top card-img-top-custom" alt="Imagen del producto 3">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="card h-">
                    <img src="fotos/baño4.png" class="card-img-top card-img-top-custom" alt="Imagen del producto 4">
                    <div class="card-body">
